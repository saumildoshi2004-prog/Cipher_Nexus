...
.input-group input{width:100%;padding:15px;border-radius:15px;border:1px solid var(--border);background:var(--input);color:var(--text);outline:none;font-size:15px;}
...
.btn-signup{width:100%;display:flex;justify-content:center;align-items:center;gap:8px;text-decoration:none;background:transparent;color:var(--btn-primary);border:2px solid var(--btn-primary);border-radius:40px;padding:15px;font-weight:700;transition:.3s;}
.btn-signup:hover{background:var(--btn-primary);color:#fff;}
</style>
</head>
<body>
